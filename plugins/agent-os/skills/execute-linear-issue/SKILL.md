...
11. Implement one small slice using Red-Green-Refactor-Verify for executable behavior. The already approved documentation-only baseline uses deterministic document validation instead of TDD.
