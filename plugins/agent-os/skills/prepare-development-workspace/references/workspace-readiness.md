...
- **Project handbook:** whether `docs/INDEX.md` and the task-relevant durable handbook documents are available, incomplete, or not initialized; absence is not a blocker unless the approved slice requires the handbook.
